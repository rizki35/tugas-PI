                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="advenjog.html">ADVENTURE JOGJA</a></li>
                                <li><a href="advenbal.html">ADVENTURE BALI</a></li>
								<li><a href="advenban.html">ADVENTURE BANDUNG</a></li>
								<li><a href="advenjak.html">ADVENTURE JAKARTA</a></li>
                            </ul>
                        </li>
                       	<li><a href="travel.html">Travel</a></li>
                        <li class="dropdown"><a href="#" class="dropdown-toggle " data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="false">LOGIN <b class=" icon-angle-down"></b></a><ul class="dropdown-menu">
            ...
            <ul class="slides">
              <li>
                ...
                <div class="flex-caption">
					...
					<a href="advenjog.html" class="btn btn-theme">Learn More</a>
                </div>
              </li>
              <li>
                ...
                <div class="flex-caption">
					...
					<a href="advenbal.html" class="btn btn-theme">Learn More</a>
                </div>
              </li>
              <li>
                ...
                <div class="flex-caption">
					...
					<a href="advenban.html" class="btn btn-theme">Learn More</a>
                </div>
              </li>
              <li>
                ...
                <div class="flex-caption">
					...
					<a href="advenjak" class="btn btn-theme">Learn More</a>
                </div>
              </li>
            </ul>
        </div>
		...
		<div class="row">
			...
			<div class="col-lg-3">
				<div class="widget">
					...
					<ul class="link-list">
						<li><a href="advenjog.html">Adventure Tour Jogja</a></li>
						<li><a href="advenbal.html">Adventure Tour Bali</a></li>
						<li><a href="advenban.html">Adventure Tour Bandung</a></li>
						<li><a href="advenjak.html">Adventure Tour Jakarta</a></li>
					</ul>
				</div>
			</div>
			<div class="col-lg-3">
